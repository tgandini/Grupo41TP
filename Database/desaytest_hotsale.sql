...
CREATE TABLE `hotsale` (
  ...
  CONSTRAINT `idPropiedadd` FOREIGN KEY (`idPropiedad`) REFERENCES `propiedad` (`id`),
  CONSTRAINT `idUsuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`mail`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hotsale`
--

LOCK TABLES `hotsale` WRITE;
/*!40000 ALTER TABLE `hotsale` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotsale` ENABLE KEYS */;
UNLOCK TABLES;
