...
namespace HSH_Desa_y_Test.xUC.Vista_Principal_de_usuario_Logueado_y_Deslogueado
{
    public partial class xucVistaPrincipalUsuario : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void inicializarHotSale()
        {
            this.xUCListadoHotSale1.inicializar();
        }
        ...
        internal void renderizarListaHotSale()
        {
            this.ocultarFormsDerivados();
            this.xUCListadoHotSale1.inicializar();
        ...
        internal void renderizarListaReservasFuturas()
        {
            this.ocultarFormsDerivados();
            this.xucReservasFuturas1.inicializar();
            this.xucReservasFuturas1.Visible = true;
